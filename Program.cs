...
namespace AdventOfCode
{
    class Program
    {
        ...
        static void Day04()
        {
            ...
            Console.WriteLine($"Day 04, Part1: Secure Container: {codeList_Part1.Count} valid codes");
            Console.WriteLine($"Day 04, Part2: Secure Container: {codeList_Part2.Count} valid codes");
        }
